  ...
  return (
    <section className="w-full h-full bg-appwhite py-5" id="aboutus">
      <div className="w-[90%] container mx-auto px-4">
        ...
        <div className="font-montserrat tracking-wider leading-10 text-2xl mb-16">
            ...
            <p>La ART tiene la obligación de brindar, en caso de contingencias previstas por la ley, las siguientes prestaciones en Especie:</p>
            <ul>
                <li>• Asistencia médica y farmacéutica.</li>
                <li>• Prótesis y ortopedia.</li>
                <li>• Rehabilitación.</li>
                <li>• Recalificación personal.</li>
            </ul>
            <h3>Alta</h3>
            ...
            <h3>Porcentaje de Incapacidad</h3>
            <p> En caso de que existiera una secuela producto del accidente, el porcentaje de incapacidad será estimado y notificado por la ART luego del alta laboral o al cumplirse el año del accidente (lo que ocurriese primero).<br />
            ...
            Si no se hubiera acordado, se esta en condiciones de  iniciar el reclamo administrativo  ante la Comisión médica más cercana a su domicilio. <br />
