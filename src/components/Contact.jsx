...
const Contact = () => {
  return (
    <section className="w-full h-screen font-montserrat bg-appwhite container mx-auto px-4 py-5 flex mt-16">
        ...
        <form className="w-1/2  mt-16 flex flex-col">
            ...
            <button className="bg-apporange px-16 py-3 rounded-md font-semibold mb-5">Enviar</button>
        </form>
    </section>
  )
}
